...
* Our QDA model has an accuracy of ~59% with a test error rate of ~41%. For the days the market did increase, we were right ~58% of the time (`Neg Pred Value`), and for those days where the market did not increase, we were never correct (`Pos Pred Value`), since the model never predicted that the market would go down.
...
* ***The proportion of negatives that are correctly identified as such (e.g. the % of healthy people who are correctly identified as not having the condition).***
