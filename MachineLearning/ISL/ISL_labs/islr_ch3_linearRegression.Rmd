...
```
  ...
  * For our Residuals vs Leverage, we have what looks like 2-possible high levarage points (indicatred by annotations of 117 and 94), which means these points are influencing our regression of `mpg` onto `horsepower`
