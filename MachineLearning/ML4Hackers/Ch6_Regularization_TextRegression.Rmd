...
Use `geom_smooth` without any `method` argument to fit a more complex statistical model called a **Generalized Additive Model (GAM)** that provides a smooth, nonlinear representation of the structure in our data:
```{r}
set.seed(1)
x <- seq(-10, 10, by = 0.01)
